class StringUtils {
  ...
  static bool isApenasLetras(String texto) {
    return RegExp(r'^[a-zA-ZÀ-ÿ\s]+$').hasMatch(texto);
  }

  /// Trunca uma string adicionando reticências se necessário
  static String truncar(
    String texto,
    int tamanhoMaximo, {
    String sufixo = '...',
  }) {
  ...
  static String mascarar(
    ...
    final quantidadeMascara = texto.length - inicioVisivel - fimVisivel;
    final meio = mascara * quantidadeMascara;
  ...
  static String gerarStringAleatoria(
    int tamanho, {
